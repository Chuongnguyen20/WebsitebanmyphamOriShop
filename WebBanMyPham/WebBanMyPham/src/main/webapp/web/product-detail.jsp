          ...
          <div class="product-sync-init mb-20">
            <div class="single-product">
              ...
              <!--    <img src="assets/img/slider/thumb/1.jpg" alt="product-thumb" /> -->
              		<img src="assets/img/product/${product.imageName}" alt="product-thumb" />
              </div>
            </div>
            <!-- single-product end -->
            <div class="single-product">
      ...
      <div class="col-lg-6">
        <div class="single-product-info">
          <div class="single-product-head">
            <h2 class="title mb-20">${product.productName}</h2>
          ...
          <div class="product-footer">
            ...
            >
              <div>
                <a href="cart?action=add-cart&productId=${product.id}" class="btn btn-dark btn--xl mt-5 mt-sm-0">
